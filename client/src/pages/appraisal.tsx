              ...
              <div className="p-5 space-y-5">
                ...
                <div className="pt-5 mt-5 border-t border-slate-700/50">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-md font-semibold text-white">Market Search & Profit</h3>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-slate-800/50 border-slate-700 text-white h-11 uppercase"
                        maxLength={7}
                      />
                    </div>
                    <div>
                      <Label className="text-slate-400 text-xs mb-1.5 block flex items-center gap-1.5">
                        <Target className="w-3.5 h-3.5" />Search Radius
                      </Label>
                      <Select value={searchRadius} onValueChange={setSearchRadius}>
                        <SelectTrigger data-testid="select-trigger-radius" className="bg-slate-800/50 border-slate-700 text-white h-11">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent className="bg-slate-800 border-slate-700">
                          <SelectItem value="25" className="text-white hover:bg-slate-700">25 km</SelectItem>
                          <SelectItem value="50" className="text-white hover:bg-slate-700">50 km</SelectItem>
                          <SelectItem value="100" className="text-white hover:bg-slate-700">100 km</SelectItem>
                          <SelectItem value="200" className="text-white hover:bg-slate-700">200 km</SelectItem>
                          <SelectItem value="500" className="text-white hover:bg-slate-700">500 km</SelectItem>
                          <SelectItem value="all" className="text-white hover:bg-slate-700">All Canada</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    <div className="md:col-span-2">
                      <Label className="text-slate-400 text-xs mb-1.5 block flex items-center gap-1.5">
                        <DollarSign className="w-3.5 h-3.5" />Desired Profit ($)
                      </Label>
                      <Input
                        ...
                        className="bg-slate-800/50 border-slate-700 text-white h-11"
                      />
                      <p className="text-slate-500 text-xs mt-1">How much profit do you want to make on this vehicle?</p>
                    </div>
                  </div>
                </div>
              ...
              <GlowCard>
                ...
                <div className="p-5 space-y-5">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <MiniStatCard label="Avg Price" value={appraisal.marketIntelligence.avgPrice > 0 ? `$${Math.round(appraisal.marketIntelligence.avgPrice).toLocaleString()}` : "N/A"} icon={DollarSign} color="emerald" />
